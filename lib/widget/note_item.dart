      ...
      child: Column(
        ...
        children: [
          ListTile(
            ...
            subtitleTextStyle: TextStyle(color: Colors.black.withOpacity(.5),fontSize: 18),
            trailing: IconButton(onPressed: (){},icon:const Icon(FontAwesomeIcons.trash,color: Colors.black,size: 24,),),
          ),
          Padding(
            padding: const EdgeInsets.only(right: 24),
            child: Text('May 21, 2021',style: TextStyle(color: Colors.black.withOpacity(.5),fontSize: 16),),
          ),
        ],
      ),
    );
